...
      navigateToSection(searchResults[0]);
    }
  };

 const navigateToSection = (section) => {
  navigate(section.route, { state: { scrollTo: section.id } });
  setSearchQuery("");
  setSearchResults([]);
  setShowResults(false);
};
...
        await axios.post(
          `https://annpurna-backend-live.onrender.com/submit-enquiry`,
          values
        );
...
              <p className="header-cf-form-subtitle">
...
                className="header-cf-contact-form"
              >
                <div className="header-cf-form-grid">
                  <div className="header-cf-form-group">
                    <label
                      htmlFor="header-cf-name"
                      className="header-cf-input-label"
                    >
                      Full Name*
                    </label>
...
                  <div className="header-cf-form-group">
                    <label
                      htmlFor="header-cf-place-of-delivery"
                      className="header-cf-input-label"
                    >
                      Place of Delivery*
                    </label>
...
                      <input
                        type="text"
                        id="header-cf-place-of-delivery"
                        name="place"
                        placeholder="example: delhi"
                        value={myFormik.values.place}
                        onChange={myFormik.handleChange}
                        required
                        className="header-cf-input-field"
                      />
...
                      ></textarea>
                      <svg
                        className="header-cf-textarea-icon"
                        viewBox="0 0 24 24"
                      >
                        <path
                          fill="currentColor"
                          d="M18.5,2L19.66,4.65L22.5,5.5L19.66,6.36L18.5,9L17.34,6.36L14.5,5.5L17.34,4.65L18.5,2M10.61,8.93L7.5,7.63L4.39,8.93L5.07,12L4.39,15.07L7.5,16.37L10.61,15.07L9.93,12L10.61,8.93M18.5,15L19.66,17.65L22.5,18.5L19.66,19.36L18.5,22L17.34,19.36L14.5,18.5L17.34,17.65L18.5,15Z"
                        />
                      </svg>
                    </div>
                  </div>
...
             {/* Inside the header_top_container div, modify the header_button_container */}
...
 <a href="tel:+918047532457" className="header_button phone">
...
      DEALS PAN INDIA. BIGGEST EXPORTER OF HOME AND OFFICE INTERIORS.
    </div>
  </div>
</div>
            </div>
...
                        onMouseDown={() => navigateToSection(result)}
                      >
                        {result.title}
                      </div>
                    ))}
...
                      <a
                        style={{ color: "black", textDecoration: "none" }}
                        href="/aluminum-profile-skirtings"
                      >
                        Aluminum Profile and Skirtings
                      </a>
                      <a
...
                    <a
                      href="/locate-us"
                      className={`nav-link ${isActive("/locate-us")}`}
                    >
                      Locate Us
                    </a>
                  </li>
...
                        activeDropdown === "mobile-about" ? "open" : ""
                      }`}
                    >
                      ▼
                    </span>
...
                    <span
                      className={`mobile_dropdown_arrow ${
                        activeDropdown === "mobile-products" ? "open" : ""
                      }`}
                    >
                      ▼
                    </span>
...
                    }`}
                  >
                    <a href="/aluminum-profile-skirtings">
                      Aluminum Profile and Skirtings
                    </a>
...
                </button>
                <button
                  className="mobile_action_button phone"
                  onClick={() => (window.location.href = "tel:8047532457")}
                >
                  <span className="button-icon">📞</span>
                  Call Us
                </button>
