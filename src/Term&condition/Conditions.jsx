        ...
        <div className="terms-and-conditions-text">
          ...
          PLEASE READ THE FOLLOWING TERMS AND CONDITIONS OF USE AGREEMENT CAREFULLY
            ...
            <ol>
              ...
              <li>Pharmaceutical Product/Service Policies
              </li>
            </ol>

          <h3> WEBSITE- MERELY A VENUE/PLATFORM</h3>
          <p>
          ...
          <ul>
            ...
            <li>"Mini Dynamic Catalog": It is a professionally-designed catalog on IndiaMART along with independent control to add, delete, edit text and images as per requirement of customers.</li>
            <li>"Verified" User(s): Users are said to be verified if any of their provided primary/ secondary, mobile or email is verified by IIL.</li>
          </ul>

          <h3>USER(S) ELIGIBILITY</h3>
          <p>
          ...
          <h3>AMENDMENT TO USER(S) AGREEMENT</h3>
          <p>
          ...
          <ol>
            ...
            <li>If such User(s) impersonates or unlawfully uses another person’s or business entity’s name to post information or conduct business in any manner. Indiamart</li>
...
User(s) agree that by registering on the Web Site, they consent to the inclusion of their personal data in IIL’s on-line database and authorize IIL to share such information with other User(s). IIL may refuse registration and deny the membership and associated User ID and Password to any User(s) for whatever reason. IIL may suspend or terminate a registered membership at any time without any prior notification in interest of IIL or general interest of its User(s) without assigning any reason thereof and there shall arise no further liability on IIL of whatsoever nature due to the suspension or termination of the User account. User(s) registered on the Web Site are in no manner a part of or affiliated to IIL.
        ...
        DATA PROTECTION        </h3>
        <p>
        Personal information supplied by User(s) during the use of the Web Site is governed by IIL’s privacy policy ("Privacy Policy"). Please click here to know about the Privacy Policy..
        </p>
...
Badarpur, New Delhi - 110044, Delhi, India
          ...
          <p><strong>By continuing, you confirm that you have read, understood, and agree to these Terms and Conditions.</strong></p>
        </div>
      </div>
    </div>
  );
