...
import product19 from "./img/carpet/p6.jpeg";
// PDF brochures
...
const Carpet = () => {
 ...
 product19: {
      ...
      category: "carpetTile",
      description:
        "Our newly launched carpet tiles dalaan carpet tiles are one best and most premium carpet tiles. Cushioning also available on request",
      details: [
        { label: "Tile Size", value: "50 x 50 cm" },
  ...
  const renderProductCard = (productKey) => {
    ...
    const isDalaan = product.name.toLowerCase().includes("dalaan carpet tile");
    return (
      <div className="carpet-product-card" data-aos="fade-up">
        <div className="carpet-product-image-container" style={{position: 'relative'}}>
          {isDalaan && (
