...
import product7 from "./ProductCatalogimg/p6.jpeg";
...
import product29 from "./ProductCatalogimg/7mm-L-Shape-Aluminium-Corner.jpg";
import product30 from "./ProductCatalogimg/7-5-mm-Aluminium-HAT-Section-U-Channel.jpg";
 ...
 Glossy : useRef(null),
  ...
  const products = {
    ...
    product6: {
      ...
      description: "Design- BroadcastColorMidnightile Size50 x 50 cmMaterialNylonFinishMatteTile Thickness5-6 mmBox Contains(No of Pieces):11Usage/ApplicationOffice FlooringBrand NameWelspunColorMidnightPatternFloralIs It Water ResistanceWater ResistanceNumber Of Piece In A Box",
      details: [
    ...
    product7: {
      ...
      details: [
        { label: "Tile Size", value: "50 x 50 cm" },
        { label: "Yarn Type", value: "100% BCF Polypropylene" },
        { label: "Dye method", value: "Solution Dyed" },
        { label: "Pile Height", value: "3MM" },
        { label: "Machine Gauge", value: "1/10th" },
        { label: "Tufted Pile Weight", value: "575 GSM" },
                { label: "Total Thickness", value: "06MM" },
        { label: "Backing Type", value: "Bitumen + Felt" },
        { label: "Tile per box", value: "20 Tiles" },
        { label: "Area per box", value: "5 sqm  " },
      ],
...
//     },
  ...
  product28: {
    ...
    product29: {
      ...
      price: "₹180 / Piece",
      image: product30, // Use the aluminium door/profile image
      category: "Skirting",
      description: "Premium quality aluminium HAT section (U Channel) for versatile construction and finishing applications. Provides robust support and a clean finish for partitions, ceilings, and wall linings.",
      details: [
        { label: "Shape", value: "U Channel (HAT Section)" },
        { label: "Material", value: "Aluminum" },
        { label: "Finish", value: "Anodised / Mill Finish" },
        { label: "Thickness", value: "1.2mm / 1.5mm" },
        { label: "Length", value: "10ft / 12ft" },
        { label: "Usage/Application", value: "Partitions, Ceilings, Wall Linings" },
        { label: "Alloy", value: "Is Alloy" },
        { label: "Country of Origin", value: "Made in India" }
      ],
    },
    product30: {
      ...
      price: "₹120 / Piece",
      image: product29, // Use the aluminum skirting image
      category: "Skirting",
      description: "Aluminium Corner Guard L Angle for edge protection and neat finishing. Ideal for use in commercial and residential interiors to protect wall corners from damage.",
      details: [
        { label: "Shape", value: "L Angle (Corner Guard)" },
        { label: "Material", value: "Aluminum" },
        { label: "Finish", value: "Anodised / Mill Finish" },
        { label: "Thickness", value: "1.2mm / 1.5mm" },
        { label: "Length", value: "8ft / 10ft / 12ft" },
        { label: "Usage/Application", value: "Edge Protection, Wall Corners" },
        { label: "Alloy", value: "Is Alloy" },
        { label: "Country of Origin", value: "Made in India" }
      ],
    },
 ...
 const renderProductCard = (productKey) => {
  ...
  return (
    <div className="product-catalog-product-card" data-aos="fade-up" key={productKey}>
      <div className="product-catalog-product-image-container" style={{position: 'relative'}}>
        {product.isNewlyLaunched && (
          <div className="newly-launched-badge">Newly Launched</div>
        )}
        <img
          src={product.image}
          alt={product.name}
      ...
      <div className="product-catalog-product-content">
        <h3>{product.name}</h3>
        {/* Render description as-is if it's a React element (like <ul>), otherwise wrap in <p> */}
        {typeof product.description === 'string' ? (
          <p className="product-catalog-product-description">{product.description}</p>
        ) : (
          <div className="product-catalog-product-description">{product.description}</div>
        )}
...
return (
  ...
  <div className="product-catalog-modal-overlay">
    <div className="product-catalog-modal-content">
      ...
      <div className="product-catalog-modal-wrapper">
        <div className="product-catalog-product-info">
          ...
          {typeof currentProduct.description === 'string' ? (
            <p className="product-catalog-modal-description">{currentProduct.description}</p>
          ) : (
            <div className="product-catalog-modal-description">{currentProduct.description}</div>
          )}
