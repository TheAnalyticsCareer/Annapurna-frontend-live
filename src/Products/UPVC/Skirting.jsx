...
import product8 from "./img/skirting/7-5-mm-Aluminium-HAT-Section-U-Channel.jpg";
import product9 from "./img/skirting/7mm-L-Shape-Aluminium-Corner.jpg";
...
const Skirting = () => {
  ...
  const myFormik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      try {
        await axios.post(
          `https://annpurna-backend-live.onrender.com/submit-quote`,
          values
        );
        myFormik.resetForm();
  ...
  const products = {
    ...
    product6: {
      ...
      image: product6,
      description:
        " Aluminium Stair Nose of Size 30mm x 30mm x 3 Meter - With Rubber Capping - Natural Anodized Silver Finish and Black Powder Coated. This Products Specially Used on Steps of Stairs to Enhance the Beauty of Home and for Safety of Stairs and to make it Anti-Skid.",
      details: [
    ...
    product7: {
     ...
     product8: {
  id: 7,
  name: "Aluminium HAT Section - U Channel",
  price: "₹250 – ₹450 / Piece",
 
  image: product8,
  description:
    "Owing to our market experience and knowledge in this domain, we are providing premium quality 10 Feet Aluminium HAT Section - U Channel to our customers. This channel is available in different sizes and lengths. There are different from angles and are used in home as well as commercial buildings. Our professionals manufacture this product with best in class aluminum and advance techniques as per the set market norms. Widely known for its robust design, premium quality and rust resistance nature, this 10 Feet Aluminium HAT Section - U Channel is offered to our customers at market leading rates.",
  details: [
    { label: "Available Sizes", value: "7.5 mm, 10 mm, 15 mm" },
     { label: "Color", value: "Silver" },
    { label: "Material", value: "Aluminium (Grade 6061)" },
    { label: "Shape", value: "Square / U Channel" },
    { label: "Surface Treatment", value: "Coated" },
    { label: "Temper Options", value: "H12, H14, H16, H18, H24, H88" },
    { label: "Strength", value: "220 – 270 MPa" },
    { label: "Usage & Applications", value: "Industrial" },
    { label: "Warranty", value: "Yes" },
    { label: "Supply Ability", value: "2000 Pieces Per Week" },
    { label: "Price Range", value: "₹250 – ₹450 per Piece (depending on size)" },
  ],
},

product9: {
  id: 7,
  name: "Aluminium Corner Guard L Angle",
  price: "₹150 – ₹280 / Piece",
  
  image: product9,
  description:
    "Among our clients, we have extended ourselves as most popular manufacturer and supplier of finest quality 7mm Aluminium L Profile / L Courner Guard . Our angles are made by expert vendors by using best quality aluminum. These angles are used for different applications such as electric fittings, coupling and air craft fittings. Customers can avail from us a wide range of the 7mm Aluminium L Profile / L Courner Guard at affordable prices and in best packing to protect these from damage during transportation.",
  details: [
    { label: "Available Sizes", value: "7 mm, 12 mm, 15 mm, 18 mm, 25 mm" },
    { label: "Color", value: "Silver" },
    { label: "Material", value: "Aluminium (Commercial Grade)" },
    { label: "Shape", value: "L Angle" },
    { label: "Surface Treatment", value: "Polished / Oxidation-Resistant" },
    { label: "Hardness", value: "High" },
    { label: "Strength", value: "High" },
    { label: "Product Type", value: "Aluminium Profiles" },
    { label: "Size", value: "Customized options available" },
    { label: "Usage & Applications", value: "Industrial / Corner Protection" },
    { label: "Supply Ability", value: "2000 Pieces Per Day / Week" },
    { label: "Price Range", value: "₹150 – ₹280 per Piece (depending on size)" },
  ],
},
